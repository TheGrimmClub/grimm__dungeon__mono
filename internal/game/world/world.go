...
// Item is a thing the player can examine and possibly carry.
type Item struct {
	Kind        string `yaml:"kind"`
	ID          string `yaml:"id"`
...
// direction key used in room exits.
var canonicalDirections = map[string]string{
	"norden": "norden", "nord": "norden", "n": "norden",
	"sueden": "sueden", "süden": "sueden", "sued": "sueden", "süd": "sueden", "s": "sueden",
	"osten": "osten", "ost": "osten", "o": "osten",
	"westen": "westen", "west": "westen", "w": "westen",
	"oben": "oben", "hoch": "oben", "rauf": "oben", "hinauf": "oben",
	"unten": "unten", "runter": "unten", "hinab": "unten", "hinunter": "unten",
}
